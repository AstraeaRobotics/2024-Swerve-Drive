...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem() {
    gyro.reset();
    this.m_frontLeftModule = new SwerveModule("Front Left: ", 8, 7, 270); // fix id
    this.m_frontRightModule = new SwerveModule("Front Right: ", 2, 1, 0); // fix id
    this.m_backLeftModule = new SwerveModule("Back Left: ", 6, 5, 180); // fix id
    this.m_backRightModule = new SwerveModule("Back Right: ", 4, 3, 90); // fix id
  }
