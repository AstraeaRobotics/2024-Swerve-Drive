...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_swerveSubsystem.setDefaultCommand(new TeleopSwerve(this.m_swerveSubsystem, driverGamepad::getLeftX, driverGamepad::getLeftY, driverGamepad::getRightX, driverGamepad::getRightY));
